...
namespace AricCar.Migrations
{
    ...
    partial class AricCarDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AricCar.Cars.Car", b =>
                {
                    b.Property<Guid>("Id")
                    ...
                    b.HasIndex("DistrctCode");

                    b.ToTable("AppCars", (string)null);
                });

            modelBuilder.Entity("AricCar.Cars.CarImage", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("AppCarImages", (string)null);
                });

            modelBuilder.Entity("AricCar.Regions.Region", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("AricCar.Cars.Car", b =>
                {
                    b.HasOne("AricCar.Regions.Region", "Region")
                        .WithMany()
                        .HasForeignKey("DistrctCode")
                        .HasPrincipalKey("DistrictCode")
            ...
            modelBuilder.Entity("AricCar.Cars.CarImage", b =>
                {
                    b.HasOne("AricCar.Cars.Car", null)
                        .WithMany("Images")
                        .HasForeignKey("CarId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
